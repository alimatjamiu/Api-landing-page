...
<div className="lg:p-8 mb-20 lg:mb-12">
      ...
      <div className="flex flex-col  py-2 lg:w-[40%] lg:mt-8 lg:mr-10 xl:mr-22 text-center lg:text-left">
        ...
        <p className="text-[#9e9aa7] text-sm  font-semibold px-10 mt-2 lg:mt-0 lg:px-0">Build your brand’s recognition and get detailed insights on how your links are performing.</p>
